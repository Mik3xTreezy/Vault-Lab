...
// Import the complete wallet icon data
import { COMPLETE_WALLET_ICON_DATA } from './wallet-icon-data';

// Wallet icon for finance tab - using complete data with hover animation
export const WALLET_ICON_DATA = COMPLETE_WALLET_ICON_DATA;
