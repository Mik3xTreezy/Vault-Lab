...
export default function Landing() {
  ...
  const handleSocialSignIn = async (strategy: "oauth_google" | "oauth_discord" | "oauth_facebook") => {
    setIsLoading(true)
    setError("")
        ...
        `}</style>
          ...
          <div className="flex justify-center gap-4 mt-4">
            <button
              ...
              className="bg-white/10 hover:bg-white/20 rounded-full p-3 transition-colors border border-white/10 disabled:opacity-50 disabled:cursor-not-allowed"
